...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        csscomb: {
            dynamic_mappings: {
                expand: true,
                cwd: 'app/assets/dist/dev/stylesheet/',
                src: ['*.css', '!*.resorted.css'],
                dest: 'app/assets/dist/dev/stylesheet/',
                ext: '.resorted.css'
            }
        },
        ...
        uglify: {
            devClientSide: {
                ...
                files: [{
                    expand: true,
                    cwd: 'app/assets/src/javascript/client-side',
                    src: '**/*.js',
                    dest: 'app/assets/dist/dev/javascript/client-side'
                }]
                //files: {
            ...
            prod: {
                ...
                files: {
                    'app/assets/dist/prod/javascript/script.min.js': 'app/assets/src/javascript/client-side/*.js'
                }
            }
        },
        ...
        watch: {
            ...
            data: {
                files: ['app/assets/src/**/*.less', "app/assets/src/**/*.js"], // tous les fichiers Less and js
                tasks: ['app-build']
            }
        }
    })
